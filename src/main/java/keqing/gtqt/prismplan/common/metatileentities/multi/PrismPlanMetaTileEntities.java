...
import keqing.gtqt.prismplan.common.metatileentities.multi.multiblockpart.MetaTileEntityMEInterface;
...
public class PrismPlanMetaTileEntities {
    ...
    //测试
    public static MetaTileEntityMEInterface ME_INTERFACE;
    ...
    public static void initialization() {
        ...
        ME_INTERFACE = registerMetaTileEntity(startId, new MetaTileEntityMEInterface(prismPlanID("me_interface")));
        ME_WATCHER = registerMetaTileEntity(startId + 1, new MetaTileEntityWatcher(prismPlanID("me_watcher")));
        //可以用的
        ...
        PARALLEL_HATCH[0] = registerMetaTileEntity(startId + 135, new MetaTileEntityParallelHatch(prismPlanID("parallel_hatch.1"), 1, 32));
        PARALLEL_HATCH[1] = registerMetaTileEntity(startId + 136, new MetaTileEntityParallelHatch(prismPlanID("parallel_hatch.2"), 2, 256));
        PARALLEL_HATCH[2] = registerMetaTileEntity(startId + 137, new MetaTileEntityParallelHatch(prismPlanID("parallel_hatch.3"), 3, 2048));
        PARALLEL_HATCH[3] = registerMetaTileEntity(startId + 138, new MetaTileEntityParallelHatch(prismPlanID("parallel_hatch.4"), 4, 16384));
        PARALLEL_HATCH[4] = registerMetaTileEntity(startId + 139, new MetaTileEntityParallelHatch(prismPlanID("parallel_hatch.5"), 5, 131072));

        THREAD_HATCH[0] = registerMetaTileEntity(startId + 140, new MetaTileEntityThreadHatch(prismPlanID("thread_hatch.1"), 1, 1, 0));
        THREAD_HATCH[1] = registerMetaTileEntity(startId + 141, new MetaTileEntityThreadHatch(prismPlanID("thread_hatch.2"), 2, 2, 0));
        THREAD_HATCH[2] = registerMetaTileEntity(startId + 142, new MetaTileEntityThreadHatch(prismPlanID("thread_hatch.3"), 3, 4, 0));
        THREAD_HATCH[3] = registerMetaTileEntity(startId + 143, new MetaTileEntityThreadHatch(prismPlanID("thread_hatch.4"), 4, 8, 0));
        THREAD_HATCH[4] = registerMetaTileEntity(startId + 144, new MetaTileEntityThreadHatch(prismPlanID("thread_hatch.5"), 5, 16, 0));

        THREAD_HATCH[5] = registerMetaTileEntity(startId + 145, new MetaTileEntityThreadHatch(prismPlanID("thread_hatch.hyper.1"), 1, 0, 2));
        THREAD_HATCH[6] = registerMetaTileEntity(startId + 146, new MetaTileEntityThreadHatch(prismPlanID("thread_hatch.hyper.2"), 2, 0, 4));
        THREAD_HATCH[7] = registerMetaTileEntity(startId + 147, new MetaTileEntityThreadHatch(prismPlanID("thread_hatch.hyper.3"), 3, 0, 8));
        THREAD_HATCH[8] = registerMetaTileEntity(startId + 148, new MetaTileEntityThreadHatch(prismPlanID("thread_hatch.hyper.4"), 4, 0, 16));
        THREAD_HATCH[9] = registerMetaTileEntity(startId + 149, new MetaTileEntityThreadHatch(prismPlanID("thread_hatch.hyper.5"), 5, 1, 32));
    }
}
