...
public class PPDriveWatcher <T extends IAEStack<T>> extends MEInventoryHandler<T> {

    private int oldStatus = 0;
    private final ItemStack is;
    private final ICellHandler handler;
    private final TilePPDrive drive;
    private final IActionSource source;
    public PPDriveWatcher(final ICellInventoryHandler i, final ItemStack is, final ICellHandler han, final TilePPDrive drive) {
